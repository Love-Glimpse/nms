...
import com.kuaidu.nms.system.serviceImpl.ModuleMapperImpl;
...
public class ModuleManage {
	@Autowired
	private ModuleMapperImpl mImpl;
	
	public ModuleMapperImpl getmImpl() {
		return mImpl;
	}

	public void setmImpl(ModuleMapperImpl mImpl) {
		this.mImpl = mImpl;
	}
