...
public class HttpUtil {  
    ...
    public static String postWithJson(String url, String json,int connectTimout,int socketTimeout) {
		String returnValue = "";
		...
		try{
	        ...
	        RequestConfig requestConfig = RequestConfig.custom() .setConnectTimeout(connectTimout).setSocketTimeout(socketTimeout).build();  
    ...
    public static String getHttpContentType(String urlstr,int connectTimeout, int readTimeout){  
