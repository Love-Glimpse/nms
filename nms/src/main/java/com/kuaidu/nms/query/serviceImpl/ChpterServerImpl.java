...
/*			if (chapterList.getContent_upload_flag()==1) {
	 ...
	 * 根据book_id 查询所有章节
	 * **/
	public List<Object> getAllChapterByBookID(Integer book_id) {
		// TODO Auto-generated method stub
		return chapterMapper.getAllChapterByBookID(book_id);
	}

	public List<ChapterList> getNeedClearChapterList() {
		// TODO Auto-generated method stub
		return chapterMapper.getNeedClearChapterList();
	}
}
