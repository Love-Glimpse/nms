...
<style type="text/css">
  ...
  %> 
     ...
     <div style="width: 13%; background-color: #3992d0; float: left;">
       <div class="container">
		  <div class="leftsidebar_box">
			<div class="line"></div>
			<dl class="system_log">
				<dt onClick="changeImage()">系统记录<img src="static/images/left/select_xl01.png"></dt>
				<dd class="first_dd"><a href="https://www.baidu.com/" target="display" >充值记录</a></dd>
				<dd><a href="https://www.baidu.com/" target="display">短信充值记录</a></dd>
				<dd><a href="#">消费记录</a></dd>
				<dd><a href="#">操作记录</a></dd>
			</dl>
		  </div>
