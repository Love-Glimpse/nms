...
<style type="text/css">
  ...
  <body>
    	<table title="系统模块管理" class="easyui-treegrid" style="width:100%;height:99%;" id="treegrid"  >
		<thead>
			<tr>
				<th></th>
				<th></th>
    ...
    <div id="tb" style="padding:5px;height:auto">
     ...
     <script type="text/javascript" src="static/js/scripts/System/module.js"></script>
  </body>
</html>
