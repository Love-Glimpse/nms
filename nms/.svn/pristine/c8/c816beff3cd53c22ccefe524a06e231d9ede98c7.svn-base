                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-6 today-nm" style="padding:0">
                                            <strong>普通充值</strong>
                                            <div>
                                                <b class="text-primary">0.00</b>
                                            </div>
                                            <div>
                                            	    已支付:
                                                <b class="text-warning">0</b> 笔
                                            </div>
                                            <div>
                                              	  未支付:
                                                <b class="text-warning" >0</b> 笔
                                            ...
                                            <div>
                                           		     完成率:
                                                <b class="text-warning"><span>0</span> %</b>
                                            </div>
                                        </div>
                    ...
                    <div class="panel panel-default" id="order-daily-stats-panel">
                        ...
                        <table id="order-table" class="table table-bordered table-striped "style="">
                            ...
                            <tr>
                                ...
                                <th class="text-center">普通充值支付订单数</th>
...
<!--                                 <th class="text-center">VIP会员</th>
                     ...
                     <!--       <tr>
                                <td><span class="order-time text-center">2018-08-29</span></td>
                                <td class="text-center"> <b>&yen; <span class="order-money">0.00</span></b> </td>
                                <td class="text-right">
                                    <b>&yen; <span class="ordinary-money">0.00</span></b>
                                    <div class="text-muted" style="font-size:13px;margin-top:5px">
                                    	    充值人数:
                                        <span class="ordinary-num">0</span>, 人均: &yen;
                                        <span class="ordinary-percent">0.00</span>
                                    </div>
                                </td>
                                <td class="text-right"> <b><span class="ordinary-times">0</span> 笔</b>
                                    <div class="text-muted" style="font-size:13px;margin-top:5px">
                                        <span class="ordinary-times-num">0</span> 笔未支付, 完成率:
                                        <span class="ordinary-times-percent">0</span> %
                                    </div>
                                </td>
                                <td class="text-right"> <b>&yen; <span class="quarterly-money">0.00</span></b>
                                    <div class="text-muted" style="font-size:13px;margin-top:5px">
                                     	   充值人数:
                                        <span class="quarterly-num">0</span>, 人均: &yen;
                                        <span class="quarterly-percent">0.00</span>
                                    </div>
                                </td>
                                <td class="text-right"> <b><span class="quarterly-times">0</span> 笔</b>
                                    <div class="text-muted" style="font-size:13px;margin-top:5px">
                                        <span class="quarterly-times-num">0</span> 笔未支付, 完成率:
                                        <span class="quarterly-times-percent">0</span> %
                                    </div>
                                </td>
<!--                                 <td class="text-right"> <b>&yen; <span class="year-money">0.00</span></b>
                ...
                <div id="people-statistics" class="active2" >
                    ...
                    <div class="row" id="member-summary-stats-panel">
                        <div class="col-md-3">
                            <div class="well">
                                <b> 今日新增 <i class="fa fa-question-circle js-tooltip" title="今日新增人数"></i></b>
                                <div class="text-primary" style="font-size:32px;margin:5px 0">
                                    <span class="today-num">0</span>
                                 ...
                                 <div>
                                    <div>
                                  		 已关注:
                                        <b class="text-warning"> <span class="today-sub-num">0</span> </b>
                                        <i class="fa fa-question-circle js-tooltip text-muted" title="今日关注人数"></i>
                                    </div>
                                </div>
                                <div>
                                    <div>
                        ...
                        <div class="col-md-3">
                            <div class="well">
                                <b>昨日新增 <i class="fa fa-question-circle js-tooltip" title="昨日新增人数"></i></b>
                                <div class="text-primary" style="font-size:32px;margin:5px 0">
                                    <span class="yesterday-num">0</span>
                                    <div style="font-size:13px;" class="text-muted">
                                 ...
                                 <div>
                                    <div>
                                  		 已关注:
                                        <b class="text-warning"> <span class="yesterday-sub-num">0</span> </b>
                                        <i class="fa fa-question-circle js-tooltip text-muted" title="昨日关注人数"></i>
                                    </div>
                                </div>
                                <div>
                                    <div>
                            ...
                            <div class="well">
                                ...
                                <div class="text-primary" style="font-size:32px;margin:5px 0">
                                 ...
                                 <div>
                                    <div>
                                  		 已关注:
                                        <b class="text-warning"> <span class="month-sub-num">0</span> </b>
                                        <i class="fa fa-question-circle js-tooltip text-muted" title="本月关注人数"></i>
                                    </div>
                                </div>
                                <div>
                                    <div>
                        ...
                        <div class="col-md-3">
                            <div class="well"><!--today yesterday This month all-time-->
                                ...
                                <div class="text-primary" style="font-size:32px;margin:5px 0">
                                    <span class="all-time-num">2</span>
                                    <div style="font-size:13px;" class="text-muted">
                                 ...
                                 <div>
                                    <div>
                                  		 已关注:
                                        <b class="text-warning"> <span class="all-time-sub-num">0</span> </b>
                                        <i class="fa fa-question-circle js-tooltip text-muted" title="关注人数"></i>
                                    </div>
                                </div>
                                <div>
                                    <div>
                    ...
                    <div class="panel panel-default" id="member-daily-stats-panel">
                        ...
                        <table class="table table-bordered table-striped" data-bind="visible: !loading()" style="">
                            ...
                            <tbody id="user-table">
	<!--                             <tr>
	                                <td> <span data-bind="date: date">2018-08-29</span> </td>
	                                <td class="text-center"> <span class="new-count">0</span> </td>
	                                <td class="text-center"> <span class="pay-count">0</span> </td>
	                                <td class="text-center">
	                                    <div class="text-muted" style="font-size:13px;margin-top:5px">
	                                    	    新增人数:
	                                        <span class="ordinary-num">0</span>, 已付费: &yen;
	                                        <span class="ordinary-percent">0</span>
	                                    </div>
									</td>
	                                <td class="text-center"> 
		                                <div class="text-muted" style="font-size:13px;margin-top:5px">
                        ...
                        <div style="text-align:center;background:#f9f9f9;padding:10px 0;border-top:#ddd 1px solid" >
                            <a href="javascript:;" onclick="getUserStatsList()">加载更多</a>
                        </div>
                    </div>
...
<script src="static/js/scripts/PushChannel/dataOverviewProxy.js"></script>
</body>
</html>
