...
/*				partnerPushUrl.setSource_url("http://c"+partnerInfo.getParent_id()+".mzshu.com/user/readLog/"+
						partnerPushUrl.getBook_id()+ "/"+partnerPushUrl.getChapter_num()+"?type=3");*/
				partnerPushUrl.setSource_url("https://mzshu.com/push/"+
						partnerPushUrl.getBook_id()+ "/"+partnerPushUrl.getChapter_num()+"?type=3&pId="+partnerInfo.getParent_id());
				...
				partnerPushUrl.setSource_url("https://mzshu.com?pId="+partnerInfo.getParent_id());
			}
			...
			String url = "https://mzshu.com/referral/"+partnerPushUrl.getPush_id()+"?pId="+partnerInfo.getParent_id();
	...
	public RestReturn updatePartnerPushUrl(Integer pushId, String name, BigDecimal cost) {
		 int num = partnerPushUrlMapper.updatePartnerPushUrl(pushId,name,cost);
		 if (num > 0) {
			return RestReturn.success();
		}
		 return RestReturn.fail();
