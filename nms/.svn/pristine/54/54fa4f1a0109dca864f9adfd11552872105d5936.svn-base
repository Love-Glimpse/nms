  ...
  <body>
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-lock" plain="true" onclick="channelGroupAuthority()">权限</a>
	...
	<table title="渠道分组" style="width:100%;height:99%;" id="grid">
			<thead>
				<tr>
					<th></th>
					<th></th>
	   ...
	   <div style="display:inline-block;">
          <table border="0" style="border-collapse:separate; border-spacing:10px;display: none;" id="dialog_table" >
            <tr align="right" style="margin-top: 10px;">
              ...
              <td><input type="text" class="text" id="add_group_name"></td>
            </tr>
            <tr align="right">
              <td class="font_size">分组描述：</td>
             <td><input type="text" class="text" id="add_group_desc"></td>
            </tr>
          </table>
        </div>
	...
	<script type="text/javascript" src="static/js/scripts/PushChannel/channelGroup.js"></script>
  </body>
