...
public class PartnerwxCfgMapperImpl {
	...
	public List<Integer> getChargeTempIds() {
		// TODO Auto-generated method stub
		return pMapper.getChargeTempIds();
	}

	public int updateChargeTemplate(int partner_id, Integer chargeTempId, Integer vip_flag) {
		// TODO Auto-generated method stub
		int ret = 0;
		try {
			pMapper.updateChargeTemplate(partner_id,chargeTempId,vip_flag);
			ret = 1;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
