...
<div class="page-content">
	<input id="hide_partner_id" value="${partner_id}" type="hidden"  >
...
<!--                                 <th class="text-center">VIP会员</th>
                ...
                <div id="people-statistics" class="active2" >
                    ...
                    <div class="row" id="member-summary-stats-panel">
                        <div class="col-md-3">
                            <div class="well">
                                <b> 今日新增 <i class="fa fa-question-circle js-tooltip" title="今日新增关注"></i></b>
                                <div class="text-primary" style="font-size:32px;margin:5px 0">
                                ...
                                <div>
                                 ...
                                 <div>
                                    <div>
                                        ...
                                        <i class="fa fa-question-circle js-tooltip text-muted" title="今日取消关注人数"></i>
                                    </div>
                                </div>
                                <div>
                                    <div>
                        ...
                        <div class="col-md-3">
                            <div class="well">
                                <b>昨日新增 <i class="fa fa-question-circle js-tooltip" title="昨日新增关注人数"></i></b>
                                <div class="text-primary" style="font-size:32px;margin:5px 0">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <i class="fa fa-question-circle js-tooltip text-muted" title="昨日取消关注人数"></i>
                                    </div>
                                </div>
                                <div>
                                    <div>
                        ...
                        <div class="col-md-3">
                            <div class="well">
                                <b>本月新增 (不含当日) <i class="fa fa-question-circle js-tooltip" title="不含当日，非实时，每天凌晨1:00左右更新(关注用户)"></i></b>
                                <div class="text-primary" style="font-size:32px;margin:5px 0">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <i class="fa fa-question-circle js-tooltip text-muted" title="本月取消关注人数"></i>
                                    </div>
                                </div>
                                <div>
                                    <div>
                        ...
                        <div class="col-md-3">
                            <div class="well"><!--today yesterday This month all-time-->
                                <b>所有时间 <i class="fa fa-question-circle js-tooltip" title="不含当日，非实时，每天凌晨1:00左右更新(新增关注)"></i></b>
                                <div class="text-primary" style="font-size:32px;margin:5px 0">
                                    <span class="all-time-sub-num">0</span>
                                    <div style="font-size:13px;" class="text-muted">
                                        <b class="text-warning all-time-boy">0</b> 男性,
                                        <b class="text-warning all-time-girl">0</b> 女性,
                                        <b class="text-warning all-time-unknown" title="用户未设置性别或未关注而无法获取性别">0</b> 未知
                                    </div>
                                </div>
                                 <div>
                                    <div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <i class="fa fa-question-circle js-tooltip text-muted" title="取消关注人数"></i>
                                    </div>
                                </div>
                                <div>
                                    <div>
...
<script src="static/js/scripts/partner/dataStat/statistics.js"></script>
</body>
</html>
